...
"hight-zc-addeuqa-17.lp"(The model file of 17 round zero-correlation of hight).
	2.We select one trail in file "Find trail/result" to check, so in "hight-zc-addeuqa-17
.lp", we add "p15 = 1" at line 6 and "p7Rd17 = 1" at line 8.
...
make the model file "hight-zc-addequa-17-LeftOneByteIn9Round.lp" still infeasible.

PART II
	1.Run "hight-zc-addequa-1-9.py" to get "hight-zc-addequa-1-9.lp".
	2.Run "9r-hight-zc.sh" to get the possible sets of the byte of round 9 
under the fixed input in round 1.
	3.In "txt-1", if the output byte of round 9 is impossible, it will print "infeasible"
in next line.

PART III
	1.Run "hight-zc-addequa-10-17.py" to get "hight-zc-addequa-10-17.lp".
	2.Run "10-17r-hight-zc.sh" to get the possible sets of the byte of round 10
